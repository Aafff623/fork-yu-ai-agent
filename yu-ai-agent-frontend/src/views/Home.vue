  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">threetwoaAI超级智能体</h1>
      </div>
...
// 设置页面标题和元数据
useHead({
  title: 'threetwoaAI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'threetwoaAI超级智能体应用平台提供AI恋爱大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI恋爱大师,AI助手,智能对话,threetwoa,AI超级智能体,首页'
    }
  ]
})
